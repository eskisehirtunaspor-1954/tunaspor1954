...
export default function AntrenorGirisPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    router.push("/antrenor/panel");
  }

  return (
    <div className="max-w-md mx-auto px-4 py-24">
      <p className="eyebrow mb-3 text-center">Tunaspor 1954 Akademi</p>
      <h1 className="font-display text-3xl mb-8 text-center">Antrenör Girişi</h1>
      ...
      <form onSubmit={handleSubmit} className="glass-panel p-6 space-y-4">
        ...
        <p className="text-xs text-tuna-mist text-center">
          Hesabın yoksa kulüp ofisiyle iletişime geç — antrenör hesapları güvenlik
          gereği yalnızca kulüp (süper admin) tarafından oluşturulur.
        </p>
      </form>
    </div>
  );
