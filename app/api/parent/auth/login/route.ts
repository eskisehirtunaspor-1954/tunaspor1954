...
import { verifyParentPassword, signParentSessionToken } from "@/lib/parent-auth";
...
export async function POST(req: NextRequest) {
  ...
  const sessionToken = signParentSessionToken({ parentId: parent.id, email: parent.email, kind: "parent" });
