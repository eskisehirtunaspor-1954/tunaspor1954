...
import { verifyScoutPassword } from "@/lib/scout-auth";
import { signScoutSessionToken } from "@/lib/session";
...
export async function POST(req: NextRequest) {
  ...
  const sessionToken = await signScoutSessionToken({ scoutId: scout.id, email: scout.email, kind: "scout" });
